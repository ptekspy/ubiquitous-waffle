-- Product ops tables were previously created defensively at runtime.
-- This migration makes them part of the normal Prisma deployment path.
...
CREATE INDEX IF NOT EXISTS "PostDeepDiveJob_ownerUserId_status_createdAt_idx" ON "PostDeepDiveJob"("ownerUserId", "status", "createdAt");
CREATE INDEX IF NOT EXISTS "PlannerJob_status_lockedAt_idx" ON "PlannerJob"("status", "lockedAt");
